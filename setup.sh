...
install_docker(){
    ...
    sudo curl -L https://github.com/docker/compose/releases/download/v2.15.1/docker-compose-linux-armv7 -o /usr/local/bin/docker-compose
...
setup_compose() {
    ...
    wget https://raw.githubusercontent.com/maxkarelov/redash-setup/redash-arm/data/docker-compose.yml
